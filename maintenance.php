...
// Send Maintenance Request (Tenant)
    ...
    <div class="container">
        ...
        <div class="send-form">
            ...
            <form method="POST">
                ...
                <br>
                <textarea name="issue" placeholder="Describe the issue..." required rows="3"></textarea>
                <br>
            ...
            <?php if($result && mysqli_num_rows($result) > 0): ?>
                ...
                <div class="card">
                    ...
                    <div class="progress-bar">
                        <div class="progress-fill <?php echo $row['status']; ?>-fill"></div>
                    </div>
